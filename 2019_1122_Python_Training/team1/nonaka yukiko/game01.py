...
#SURFACE = pygame.Surface.blit("img/niji.jpg",(1000,600))

#タイトルの設定
pygame.display.set_caption("鳥のお散歩")

#画像ロード
cloud = pygame.image.load("img/niji.jpg")
...
building = [pygame.image.load("img/balloon_01.png"),\
    pygame.image.load("img/balloon_01.png"),\
    pygame.image.load("img/balloon_01.png")]
...
gameover = gameoverFont.render("see you toworrow!", \
    True, (125,50,50))
